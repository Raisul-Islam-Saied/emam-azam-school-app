...
const sidebarLinkdata = [
  {
    ...
    sublinks: [
      {
        name: "এড রেজাল্ট",
        link: "/dashboard/result/add_results",
      },
      {
        name: "সব রেজাল্ট দেখুন",
        link: "/dashboard/result/see_results",
      },
      {
        name: "পাবলিশ করুন",
        link: "/dashboard/result/publish_results",
      },
    ],
  },
  {
    ...
    sublinks: [
      {
        name: "এড শিক্ষার্থী",
        link: "/dashboard/student/add_student",
      },
      {
        name: "শিক্ষার্থীর তথ্য",
        link: "/dashboard/student/student_info",
      },
    ],
  },
  {
    ...
    sublinks: [
      {
        name: "এড সিলেবাস",
        link: "/dashboard/syllabus/add_syllabus",
      },
      {
        name: "সব সিলেবাস দেখুন",
        link: "/dashboard/syllabus/see_syllabus",
      },
    ],
  },
];
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`print:hidden absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/dashboard/results/add_result"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {sidebarLinkdata.map((linkData) => {
                return (
                  <SidebarLinkGroup
                    activeCondition={pathname.includes(linkData.pathName)}
                  >
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          ...
                          >
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                              {linkData.sublinks.map((singleLink) => {
                                return (
                                  <li>
                                    <NavLink
                                      to={singleLink.link}
