...
import { Label, Radio, CheckboxGroup } from "keep-react";
...
function AddStudent({ result }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (v) => {
      const url = `student/add_student`;

      await mutation.mutateAsync({
        allFormData: { ...v, student_image: avatar },
        url,
        method: "post",
        headers: {
      ...
      <form onSubmit={formik.handleSubmit} encType="multipart/form-data">
        <motion.div initial={{ x: "100vh" }} animate={{ x: 0 }}>
          <PageTitle className="my-5">
            ...
            <PageHead className="!text-lg">
              <span className="primary-highlighter">শিক্ষাথীর</span> তথ্য দিন
            </PageHead>
          </PageTitle>
          <div className="  w-full flex flex-col md:flex-row  pb-10 gap-x-6">
            <div className=" w-full  flex-1/2">
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর নাম ইংরেজিতে"
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর জন্ম তারিখ"
                  subtitle="শিক্ষার্থীর জন্ম তারিখ সিলেক্ট করুন"
                />
                <Input
                  type="date"
                  className="h-8 "
              ...
              <FormControl className="mb-0 ">
                <FormTitle
                  title="শিক্ষার্থীর ধর্ম"
                  subtitle="শিক্ষার্থীর ধর্ম সিলেক্ট করুন"
                />
                <Select
                  options={religion}
                  name="religion"
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর জন্ম নিবন্ধন নং"
                  subtitle="শিক্ষার্থীর জন্ম নিবন্ধন নম্বর লিখুন"
                />
                <Input
                  className="h-8"
                  name="birth_no"
            ...
            <div className=" w-full flex-1/2">
              ...
              <FormControl className="mb-0 ">
                <FormTitle
                  title="শিক্ষার্থীর রক্তের গ্রুপ"
                  subtitle="শিক্ষার্থীর রক্তের গ্রুপ সিলেক্ট করুন"
                />
                <Select
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর মোবাইল নাম্বার"
                  subtitle="শিক্ষার্থীর মোবাইল নাম্বার লিখুন"
                />
                <Mobile
                  name="phone"
                  onChange={(v) => {
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর ঠিকানা বাংলায়"
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর ঠিকানা ইংরেজিতে"
                  subtitle="বাড়ির নাম , গ্রাম/রাস্তা, ইউনিয়ন, উপজেলা, জেলা কমা দিয়ে লিখুন "
                />
                <Input
                  type="text"
        ...
        <>
          <PageTitle className="my-5">
            {" "}
            <PageHead className="!text-lg">
              <span className="primary-highlighter"> শিক্ষাথীর পিতার</span> তথ্য
              দিন
            </PageHead>
          </PageTitle>
          <div className="  w-full flex flex-col md:flex-row  pb-10 gap-x-6">
            <div className=" w-full  flex-1/2">
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর পিতার নাম ইংরেজিতে"
                  subtitle="সকল কমিউনিকেশনে এই নামটি ব্যবহৃত হবে। তাই সঠিক নাম প্রদান করুন।"
                />
                <Input
                  type="text"
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর পিতার জন্ম তারিখ"
                  subtitle="শিক্ষার্থীর পিতার জন্ম তারিখ সিলেক্ট করুন"
                />
                <Input
                  type="date"
                  className="h-8 "
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর পিতার জন্ম নিবন্ধন নং"
                  subtitle="শিক্ষার্থীর পিতার জন্ম নিবন্ধন নম্বর লিখুন"
                  notRequired
                />
                <Input
                  type="number"
            ...
            <div className=" w-full flex-1/2">
              <FormControl className="mb-0">
                <FormTitle
                  ...
                  subtitle="শিক্ষার্থীর পিতার আইডি নম্বর লিখুন"
                />
                <Input
                  type="number"
                  className="h-8"
        ...
        <>
          <PageTitle className="my-5">
            {" "}
            <PageHead className="!text-lg">
              <span className="primary-highlighter"> শিক্ষাথীর মাতার</span> তথ্য
              দিন
            </PageHead>
          </PageTitle>
          <div className="  w-full flex flex-col md:flex-row  pb-10 gap-x-6">
            <div className=" w-full  flex-1/2">
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর মাতার নাম ইংরেজিতে"
                  subtitle="সকল কমিউনিকেশনে এই নামটি ব্যবহৃত হবে। তাই সঠিক নাম প্রদান করুন।"
                />
                <Input
                  type="text"
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর মাতার জন্ম তারিখ"
                  subtitle="শিক্ষার্থীর মাতার জন্ম তারিখ সিলেক্ট করুন"
                />
                <Input
                  type="date"
                  className="h-8 "
              ...
              <FormControl className="mb-0">
                <FormTitle
                  title="শিক্ষার্থীর মাতার জন্ম নিবন্ধন নং"
                  subtitle="শিক্ষার্থীর মাতার জন্ম নিবন্ধন নম্বর লিখুন"
                />
                <Input
                  type="number"
                  className="h-8"
            ...
            <div className=" w-full flex-1/2">
              <FormControl className="mb-0">
                <FormTitle
                  ...
                  subtitle="শিক্ষার্থীর মাতার আইডি নম্বর লিখুন"
                />
                <Input
                  type="number"
                  className="h-8"
        ...
        <>
          <PageTitle className="my-5">
            {" "}
            <PageHead className="!text-lg">
              <span className="primary-highlighter"> শিক্ষাথীর অভিবাবকের</span>{" "}
              তথ্য দিন
            </PageHead>
          </PageTitle>
          <div className="  w-full flex flex-col md:flex-row  pb-10 gap-x-6">
            <div className=" w-full  flex-1/2">
              <FormControl className="mb-0 ">
                <FormTitle
                  title="শিক্ষাথীর সাথে সম্পর্ক"
                  subtitle="অভিবাবক শিক্ষাথীর সম্পর্কে কি হয় তা সিলেক্ট করুন"
                />
                ...
                <RadioGroup1
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.value === "পিতা") {
                      proparty.map((value) => {
                        formik.setFieldValue(
                          `guardian.${value}`,
                          formik.values.father[value]
                        );
                      });
                      setguardianFiledDisable(true);
                    }
                    if (e.target.value === "মাতা") {
                      proparty.map((value) => {
                        formik.setFieldValue(
                          `guardian.${value}`,
                          formik.values.mother[value]
                        );
                      });
                      setguardianFiledDisable(true);
                    }
                    if (e.target.value === "অন্যান্য") {
                      proparty.map((value) => {
                        formik.setFieldValue(`guardian.${value}`, "");
                      });
                      setguardianFiledDisable(false);
                    }
                  }}
                  selected={formik.values.guardian?.relation}
                  values={["পিতা", "মাতা", "অন্যান্য"]}
                  errorMessage={
                    (formik.touched.guardian?.relation &&
                      formik?.errors?.guardian?.relation) ||
                    error?.guardian_relation?.msg
                  }
                />
              </FormControl>
              <FormControl className="mb-0 ">
                ...
                <Input
                  type="text"
                  name="guardian.name_bangla"
                  disabled={guardianFiledDisable}
                  onChange={formik.handleChange}
                  value={formik.values.guardian?.name_bangla}
                  errorMessage={
                    (formik.touched.guardian?.name_bangla &&
                      formik?.errors?.guardian?.name_bangla) ||
                    error?.guardian_name_bangla?.msg
                  }
                  className="h-8 "
                  placeholder="আমার নাম বস"
                />
              ...
              <FormControl className="mb-0">
                ...
                <Input
                  ...
                  name="guardian.name"
                  onChange={formik.handleChange}
                  value={formik.values.guardian?.name}
                  errorMessage={
                    (formik.touched.guardian?.name &&
                      formik?.errors?.guardian?.name) ||
                    error?.guardian_name?.msg
                  }
                />
              </FormControl>
              <FormControl className="mb-0">
                <FormTitle
                  title="অভিবাবকের জন্ম তারিখ"
                  subtitle="অভিবাবকের জন্ম তারিখ সিলেক্ট করুন"
                />
                <Input
                  type="date"
                  disabled={guardianFiledDisable}
                  className="h-8 "
                  name="guardian.date_of_birth"
                  errorMessage={
                    (formik.touched.guardian?.date_of_birth &&
                      formik?.errors?.guardian?.date_of_birth) ||
                    error?.guardian_date_of_birth?.msg
                  }
                  onChange={formik.handleChange}
                  value={formik.values.guardian?.date_of_birth}
                  placeholder="raiusl islam saied"
                />
              </FormControl>
            </div>
            <div className=" w-full flex-1/2">
              <FormControl className="mb-0">
                <FormTitle
                  title="মাতার জাতীয় পরিচয় পত্র নম্বর"
                  subtitle="অভিবাবকের আইডি নম্বর লিখুন"
                />
                <Input
                  disabled={guardianFiledDisable}
                  type="number"
                  className="h-8"
                  name="guardian.nid_no"
                  onChange={formik.handleChange}
                  value={formik.values.guardian?.nid_no}
                  errorMessage={
                    (formik.touched.guardian?.nid_no &&
                      formik?.errors?.guardian?.nid_no) ||
                    error?.guardian_nid_no?.msg
                  }
                />
              </FormControl>
              <FormControl className="mb-0">
                <FormTitle
                  title="অভিবাবকের জন্ম নিবন্ধন নং"
                  subtitle="অভিবাবকের জন্ম নিবন্ধন নম্বর লিখুন"
                />
                <Input
                  type="number"
                  className="h-8"
                  name="guardian.birth_no"
                  onChange={formik.handleChange}
                  value={formik.values.guardian?.birth_no}
                  disabled={guardianFiledDisable}
                  errorMessage={
                    (formik.touched.birth_no &&
                      formik?.errors?.guardian?.birth_no) ||
                    error?.guardian_birth_no?.msg
                  }
                />
              </FormControl>
              <FormControl className="mb-0">
                <FormTitle title="অভিবাবকের মোবাইল নাম্বার" />
                <Mobile
                  name="guardian.phone"
                  disabled={guardianFiledDisable}
                  disableValue={formik.values.guardian.phone}
                  onChange={(v) => {
                    formik.setFieldValue("guardian.phone", v);
                  }}
                  errorMessage={
                    (formik.touched.guardian?.phone &&
                      formik?.errors?.guardian?.phone) ||
                    error?.guardian_phone?.msg
                  }
                />
              </FormControl>
              <FormControl className="mb-0">
                ...
                <Input
                  ...
                  errorMessage={
                    (formik.touched.guardian?.email &&
                      formik?.errors?.guardian?.email) ||
                    error?.guardian_email?.msg
                  }
                />
              </FormControl>
            </div>
        ...
        <div className="  w-full flex flex-col md:flex-row  pb-10 gap-x-6">
          ...
          <div className=" w-full flex-1/2">
            <FormControl className="mb-0">
              <FormTitle title="শিক্ষার্থীর আইডি নং" />
              <Input
                type="text"
                className="h-8"
                name="student_id"
                ...
                errorMessage={
                  ...
                  error?.student_id?.msg
                }
              />
            </FormControl>
            <FormControl className="mb-0">
              <FormTitle title="শিক্ষার্থীর রোল" />
              <Input
                type="text"
                className="h-8"
                name="roll"
