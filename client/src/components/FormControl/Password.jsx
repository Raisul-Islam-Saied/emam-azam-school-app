...
<span
  ...
  className="absolute focus:animate-button w-5 top-1/2 right-2 m-auto cursor-pointer transform -translate-y-1/2"
>
{isPassword ? <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
